...
window.addEventListener("DOMContentLoaded", function () {
    if (url.includes("?")) {
        ...
        document.querySelector(".main").innerHTML = `
        <h1>漢字は好きですか？</h1>
        <h3>この世には様々な漢字があります。しかし、ややこしいものが大半です。<br>唯一わかりやすいのは、形声文字です。<br>形声文字は意味と文字が左右で別れているものです。<br>形成文字の意味を表す部分さえ分かれば、意味が分かる。<br>さらに、形成文字の音を表す部分が分かれば、読みも分かる。最高ですね。<br>ただ、残念ながらすべての漢字は形声文字ではありません。
        </h3>
